...
class ESPRESOInput(unittest.TestCase):
    ...
    def openfoam(self, path, file):
        config = { "ENV::VERBOSE_LEVEL": 0, "ENV::MEASURE_LEVEL": 0, "OUTPUT::RESULTS_STORE_FREQUENCY": "NEVER" }
...
if __name__ == '__main__':
    ...
    print "input benchmarks are not working - try benchmarks using: nosetests"
