...
//void Transformation::addLinkFromTo(Mesh &mesh, TFlags::ELEVEL from, TFlags::ELEVEL to)
//{
...
//};
//
//void Transformation::exchangeHaloElements(Mesh &mesh)
//{
...
//	std::vector<std::vector<std::vector<__haloElement__> > > sBuffer(threads, std::vector<std::vector<__haloElement__> >(mesh.neighbours.size()));
//	std::vector<std::vector<__haloElement__> > rBuffer(mesh.neighbours.size());
//
//	#pragma omp parallel for
//	for (size_t t = 0; t < threads; t++) {
...
//}
//
//void Transformation::computeDual(Mesh &mesh)
//{
...
//}
//
//void Transformation::computeDecomposedDual(Mesh &mesh, TFlags::SEPARATE separate)
//{
...
//}
//
//void Transformation::projectNodesToDomains(Mesh &mesh)
//{
...
//}
//
//void Transformation::assignDomainsToNodes(Mesh &mesh)
//{
//	if (mesh._domains == NULL) {
