...
#ifndef SRC_OUTPUT_RESULTS_VISUALIZATION_VTKLEGACY_H_
#define SRC_OUTPUT_RESULTS_VISUALIZATION_VTKLEGACY_H_
...
#endif /* SRC_OUTPUT_RESULTS_VISUALIZATION_VTKLEGACY_H_ */
