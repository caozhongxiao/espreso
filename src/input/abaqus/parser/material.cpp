...
size_t Materials::size = 9;
const char* Materials::upper     = "*MATERIAL";
const char* Materials::lower     = "*material";
const char* Materials::sentence  = "*Material";
Materials::Materials()
...
Materials& Materials::parse(const char* begin)
{
