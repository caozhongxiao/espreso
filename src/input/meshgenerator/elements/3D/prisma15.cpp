...
void Prisma15Generator::pushElements(std::vector<eslocal> &elements, const std::vector<eslocal> &indices) const
{
...
void Prisma15Generator::pushNodes(std::vector<eslocal> &nodes, const std::vector<eslocal> &indices, CubeFace face) const
{
	switch (face) {
	case CubeFace::X_0:
	case CubeFace::X_1:
...
void Prisma15Generator::pushFace(std::vector<eslocal> &elements, std::vector<eslocal> &esize, std::vector<eslocal> &etype, const std::vector<eslocal> &indices, CubeFace face) const
{
	...
	case CubeFace::Z_1:
		esize.push_back(6);
		esize.push_back(6);
		etype.push_back((eslocal)Element::CODE::TRIANGLE6);
		etype.push_back((eslocal)Element::CODE::TRIANGLE6);
		break;
	}
}
