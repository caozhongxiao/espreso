...
void GridGenerator::generate(const GridGeneratorConfiguration &configuration, Mesh &mesh)
{
	...
	grid.init();
	grid.nodes(meshData);
	grid.elements(meshData);
	grid.neighbors(meshData);
	grid.regions(configuration, meshData);

	GeneratedInput::buildMesh(meshData, mesh);
}
...
void GridGenerator::nodes(PlainMeshData &mesh)
{
...
void GridGenerator::elements(PlainMeshData &mesh)
{
...
void GridGenerator::neighbors(PlainMeshData &mesh)
{
...
void GridGenerator::regions(const GridGeneratorConfiguration &configuration, PlainMeshData &mesh)
{
