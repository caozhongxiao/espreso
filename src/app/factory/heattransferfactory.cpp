...
HeatTransferFactory::HeatTransferFactory(HeatTransferConfiguration &configuration, ResultsSelectionConfiguration &propertiesConfiguration, Mesh *mesh)
...
//			_composer.push_back(new DomainsHeatTransfer2D(configuration, configuration.load_steps_settings.at(1), propertiesConfiguration));
//			break;
//		case LoadStepConfiguration::SOLVER::MULTIGRID:
//			_composer.push_back(new GlobalHeatTransfer2D(configuration, configuration.load_steps_settings.at(1), propertiesConfiguration));
//			break;
//		}
//
//		break;
...
//		switch (configuration.load_steps_settings.at(1).solver) {
//		case LoadStepConfiguration::SOLVER::FETI:
//			_composer.push_back(new DomainsHeatTransfer3D(configuration, configuration.load_steps_settings.at(1), propertiesConfiguration));
//			break;
//		case LoadStepConfiguration::SOLVER::MULTIGRID:
//			_composer.push_back(new GlobalHeatTransfer3D(configuration, configuration.load_steps_settings.at(1), propertiesConfiguration));
//			break;
//		}
//		break;
//	default:
...
{
//	HeatTransferLoadStepConfiguration &settings = getLoadStepsSettings(step, _configuration.load_steps_settings);
//
