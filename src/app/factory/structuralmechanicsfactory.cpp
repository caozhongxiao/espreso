...
//			_composer.push_back(new DomainsStructuralMechanics2D(configuration, configuration.load_steps_settings.at(1), propertiesConfiguration));
//			break;
//		case LoadStepConfiguration::SOLVER::MULTIGRID:
//			_composer.push_back(new GlobalStructuralMechanics3D(configuration, configuration.load_steps_settings.at(1), propertiesConfiguration));
//			break;
//		}
//
//		break;
...
//		switch (configuration.load_steps_settings.at(1).solver) {
//		case LoadStepConfiguration::SOLVER::FETI:
//			_composer.push_back(new DomainsStructuralMechanics3D(configuration, configuration.load_steps_settings.at(1), propertiesConfiguration));
//			break;
//		case LoadStepConfiguration::SOLVER::MULTIGRID:
//			_composer.push_back(new GlobalStructuralMechanics3D(configuration, configuration.load_steps_settings.at(1), propertiesConfiguration));
//			break;
